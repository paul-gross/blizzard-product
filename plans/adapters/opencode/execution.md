...
stops flowing, and this step is content to let it.
...
explains its own stalls is a larger idea than this step needs.
...
resolution, and completed-turn usage and cost. The [harness selection specification](../harness-selection.md) owns the
cross-entity contract; the [OpenCode execution specification](./spec/execution.md) owns the binding.
