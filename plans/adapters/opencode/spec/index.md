...
The technical contracts behind the OpenCode slice of `epic:adapters`. Product intent begins at the
[slice plan](../index.md); implementation enters here and descends only to the concern it is changing.
