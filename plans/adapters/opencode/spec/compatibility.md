...
The compatibility step adds that method to Blizzard's verifiability matrix and gives it a runner diagnostic command
...
- **Blocking** — the execution or transcript step depending on the behavior does not ship for that version.
