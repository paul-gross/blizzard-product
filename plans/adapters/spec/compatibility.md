...
still has to settle is per-turn PID ownership, whether an export taken mid-turn is coherent, and whether a
subscription-authenticated `cost` is ever anything but zero.
