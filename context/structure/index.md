...
The registry files each have a structural guide beside this hub — the required shape a review asserts their contents
against. Read the one guide for the file you are authoring or reviewing:
...
- **Work-tracking folders of any kind** — blizzard's ready queue is GitHub and its execution record is closed issues
  plus `delivered.md`; mirroring that state in directories would create a second source of truth to drift.
